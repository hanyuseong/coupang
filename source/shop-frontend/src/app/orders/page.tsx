...
import { fetchOrders, fetchCategories, fetchCart, fetchRecommendedKeywords } from "@/lib/api";
import { Order, Category } from "@/lib/types";
...
export default function OrdersPage() {
    ...
    useEffect(() => {
        async function loadData() {
            try {
                const [ordersData, categoriesData, cartData, keywordsData] = await Promise.all([
                    fetchOrders(),
                    fetchCategories(),
                    fetchCart(),
            ...
            <main className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-8">
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-1">
                        ...
                        {orders.length === 0 ? (
                            <div className="flex min-h-[60vh] flex-col items-center justify-center bg-white rounded-lg shadow-sm border border-gray-200">
